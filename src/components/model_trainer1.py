...
from src.utils1 import save_object,model_evaluate
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_arr,test_arr):
        try:
            ...
            if max_accuracy<0.6:
                raise CustomException("There si no best machine learning model we found")
            ...
            return (r2_score_value,self.model_trainer_config.trained_model_path)
